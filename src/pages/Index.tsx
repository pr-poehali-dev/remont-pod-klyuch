  ...
  const testimonials = [
    {
      ...
      text: 'Работаем с Бизнес-Гарантом уже 3 года. Отличный сервис, всегда на связи, все отчёты вовремя. Рекомендую!',
      rating: 5
    },
    {
      name: 'Мария Соколова',
      position: 'ИП Соколова М.А.',
      text: 'Перешла от штатного бухгалтера к аутсорсингу и очень довольна. Экономлю деньги и время, а качество выше.',
      rating: 5
    },
    {
      name: 'Дмитрий Волков',
      position: 'Учредитель сети магазинов',
      text: 'Профессионалы своего дела. Помогли оптимизировать налоги, сопроводили проверку — всё прошло отлично.',
      rating: 5
    }
  ];
